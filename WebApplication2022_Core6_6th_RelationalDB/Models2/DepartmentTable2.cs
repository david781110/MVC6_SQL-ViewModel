...
namespace WebApplication2022_Core6_6th_RelationalDB.Models2
{
    ...
    {
        //**************************************************************************
        public DepartmentTable2()    // 一對多。   一個科系  有多名學生（UserTable2）
        {
        ...
        [Required]
        [StringLength(50)]
        public string DepartmentYear { get; set; } = null!;
        ...
        public virtual ICollection<UserTable2> UserTable2s { get; set; }    // 注意！後面是複數（s）。  一個科系  有多名學生（UserTable2）
